		...
		<div class="sfooter-content">
			...
			<div class="container">
				...
				<p>Michael Harrison<br>
					mikeharrison34@gmail.com<br>
					505.980.8098</p>

				<h2>Objective</h2>
				<p>I graduated from the University of New Mexico with a degree in Multimedia Design. I specialize in web
					development and have extensive background in digital marketing and multimedia development. I have been
					working in the industry for over 15 years. I am always looking for new opportunities that allow me to
					offer my knowledge as well as learn along the way.</p>

				<h2>Skills & Languages</h2>
				• Git • PHP • JavaScript • mySQL
				• GitHub • HTML5 • CSS3 • Daptiv
				• Terminal • PhpStorm • BootStrap • CMS WordPress & Drupal
				...
				<p>It was an absolute pleasure to work with Michael on the production of our new ear piercing training video
					...
					seamlessly. Michael was responsible for every aspect of our shoot and excelled as our producer, director,
					editor and graphic designer. He is extremely professional, knowledgeable, and has incredible attention to
					detail. Even though we had to conduct all of our pre-production work long distance (Attleboro to
